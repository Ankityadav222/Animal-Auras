      ...
      <div className="below-footer">
        ...
        <p>
          <a
            ...
            href="https://www.linkedin.com/in/sakshigowardipe/"
            target="_blank"
          ...
          <a
            className="contact-links"
            href="https://github.com/sakshigowardipe"
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            className="contact-links"
            href="https://www.instagram.com/sakshigowardipe/"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <p>&copy; 2024 sakshi gowardipe</p>
      </div>
    </footer>
  );
};
